...
Shader "shader"
{
	Properties
	{
		...
		_SpecularPower("SpecularPower", Range( 0 , 10)) = 3
		_Specular_Intensity("Specular_Intensity", Range( 0 , 1)) = 1
		...
		[Toggle]_RimLight_Toggle("RimLight_Toggle", Float) = 0
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float3 Normal48 = (WorldNormalVector( i , UnpackScaleNormal( tex2D( _Normal_Map, uv_Normal_Map ), _Normal_Intensity ) ));
			...
			#endif //aseld
			float dotResult64 = dot( Normal48 , ase_worldlightDir );
			float DirectLight67 = ( saturate( dotResult64 ) * ase_lightAtten );
			float3 normalizeResult52 = normalize( Normal48 );
			float3 ase_worldViewDir = normalize( UnityWorldSpaceViewDir( ase_worldPos ) );
			float3 normalizeResult4_g8 = normalize( ( ase_worldViewDir + ase_worldlightDir ) );
			float dotResult53 = dot( normalizeResult52 , normalizeResult4_g8 );
			float4 Specular70 = ( DirectLight67 * pow( saturate( dotResult53 ) , exp2( _SpecularPower ) ) * _Specular_Intensity * _SpecularColor );
			float4 Visible75 = ( Diffuse47 + ( DirectLight67 * Specular70 ) );
			float4 ase_screenPos = float4( i.screenPos.xyz , i.screenPos.w + 0.00000000001 );
			float4 ase_grabScreenPos = ASE_ComputeGrabScreenPos( ase_screenPos );
			float4 ase_grabScreenPosNorm = ase_grabScreenPos / ase_grabScreenPos.w;
			float3 objToWorldDir130 = mul( unity_ObjectToWorld, float4( Normal48, 0 ) ).xyz;
			...
			float4 Emmesive82 = ( pow( tex2D( _Emmesive_Tex, uv_Emmesive_Tex ) , 0.09 ) * _Emmesive_Color * _Emmesive_Intensity );
			...
			float4 temp_output_14_0_g11 = _Transicion_Color;
			float temp_output_20_0 = ( 1.0 - 0.0 );
			float temp_output_1_0_g9 = ( temp_output_20_0 - 0.2680089 );
			float temp_output_1_0_g13 = 0.0;
			float temp_output_4_0_g11 = 0.56;
			float4 lerpResult16_g11 = lerp( float4( 0,0,0,0 ) , temp_output_14_0_g11 , saturate( ( ( saturate( pow( saturate( ( ( ( 1.0 - abs( (-1.0 + (help176 - 0.0) * (1.0 - -1.0) / (1.0 - 0.0)) ) ) - temp_output_1_0_g9 ) / ( temp_output_20_0 - temp_output_1_0_g9 ) ) ) , exp2( 1.050046 ) ) ) - temp_output_1_0_g13 ) / ( temp_output_4_0_g11 - temp_output_1_0_g13 ) ) ));
			float temp_output_1_0_g12 = temp_output_4_0_g11;
			float4 lerpResult17_g11 = lerp( temp_output_14_0_g11 , float4( 1,1,1,0 ) , saturate( ( ( saturate( pow( saturate( ( ( ( 1.0 - abs( (-1.0 + (help176 - 0.0) * (1.0 - -1.0) / (1.0 - 0.0)) ) ) - temp_output_1_0_g9 ) / ( temp_output_20_0 - temp_output_1_0_g9 ) ) ) , exp2( 1.050046 ) ) ) - temp_output_1_0_g12 ) / ( 1.0 - temp_output_1_0_g12 ) ) ));
			float4 lerpResult18_g11 = lerp( lerpResult16_g11 , lerpResult17_g11 , step( temp_output_4_0_g11 , saturate( pow( saturate( ( ( ( 1.0 - abs( (-1.0 + (help176 - 0.0) * (1.0 - -1.0) / (1.0 - 0.0)) ) ) - temp_output_1_0_g9 ) / ( temp_output_20_0 - temp_output_1_0_g9 ) ) ) , exp2( 1.050046 ) ) ) ));
			float2 panner188 = ( 1.0 * _Time.y * float2( 0.01,0.01 ) + i.uv_texcoord);
			float4 temp_output_170_0 = ( lerpResult18_g11 * tex2D( _TransicionTex, panner188 ) * _TransEmmisive_Intensity );
...
/*ASEBEGIN
Version=18934
0;53;1440;826;6571.012;4195.57;6.700232;True;True
...
Node;AmplifyShaderEditor.CommentaryNode;84;-2179.373,-2883.519;Inherit;False;3320.507;1059.952;;11;83;42;71;49;68;72;74;75;93;94;96;When Visible;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;102;-4289.794,-180.6557;Inherit;False;Property;_Transicion_Width;Transicion_Width;12;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;49;-2128.776,-2833.345;Inherit;False;1109.7;280;Normal;4;43;46;44;48;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;43;-2078.776,-2727.743;Inherit;False;Property;_Normal_Intensity;Normal_Intensity;4;0;Create;True;0;0;0;False;0;False;5.67;0;2;6;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;107;-3694.471,-516.8657;Inherit;False;Property;_Cloaking;Cloaking;8;0;Create;True;0;0;0;False;0;False;0.6035187;0.6948692;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;48;-1243.077,-2758.366;Inherit;False;Normal;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;63;-898.0573,-2783.519;Inherit;False;48;Normal;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.CommentaryNode;71;-1359.968,-2498.76;Inherit;False;1633.278;675.1937;Specular;13;52;51;53;50;54;57;56;59;58;55;60;69;70;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;51;-1302.716,-2448.76;Inherit;False;48;Normal;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.LightAttenuation;62;-646.6594,-2636.064;Inherit;False;0;1;FLOAT;0
Node;AmplifyShaderEditor.NormalizeNode;52;-1046.484,-2400.414;Inherit;False;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;50;-1309.968,-2289.219;Inherit;False;Blinn-Phong Half Vector;-1;;8;91a149ac9d615be429126c95e20753ce;0;0;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;56;-1087.578,-2115.172;Inherit;False;Property;_SpecularPower;SpecularPower;6;0;Create;True;0;0;0;False;0;False;3;0;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;192;-4203.345,-2371.605;Inherit;False;48;Normal;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.DotProductOpNode;53;-843.4315,-2315.808;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;54;-645.2136,-2306.139;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;83;128.8508,-2851.847;Inherit;False;995.9077;448.4023;Emmesive;6;82;80;78;79;81;155;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.ColorNode;58;-420.4057,-2030.567;Inherit;False;Property;_SpecularColor;SpecularColor;5;0;Create;True;0;0;0;False;0;False;0.8867924,0.1631364,0.1631364,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;132;-3705.689,-2599.435;Inherit;False;Property;_Refraction_Intensity;Refraction_Intensity;9;0;Create;True;0;0;0;False;0;False;0.004513069;0;-0.5;0.5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;60;-517.0976,-2105.504;Inherit;False;Property;_Specular_Intensity;Specular_Intensity;7;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;55;-456.6649,-2332.729;Inherit;True;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;78;173.3636,-2802.74;Inherit;True;Property;_Emmesive_Tex;Emmesive_Tex;15;0;Create;True;0;0;0;False;0;False;-1;b30d9c999b067d040b70e1f848c7f691;b30d9c999b067d040b70e1f848c7f691;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;39;-2035.615,-2415.498;Inherit;False;Property;_Main_Tex_Color;Main_Tex_Color;2;0;Create;True;0;0;0;False;0;False;1,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;59;-120.6616,-2277.131;Inherit;True;4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;18;-1890.089,-1350.526;Inherit;False;Constant;_Fade;Fade;3;0;Create;True;0;0;0;False;0;False;0.2680089;0.385656;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.AbsOpNode;15;-1647.586,-1165.177;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;79;191.4909,-2612.023;Inherit;False;Property;_Emmesive_Color;Emmesive_Color;17;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;81;394.4368,-2508.337;Inherit;False;Property;_Emmesive_Intensity;Emmesive_Intensity;16;0;Create;True;0;0;0;False;0;False;5;5;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;168;-3871.235,-1766.329;Inherit;False;Property;_RimLight_Toggle;RimLight_Toggle;18;0;Create;True;0;0;0;False;0;False;0;True;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;162;-4072.204,-1843.584;Inherit;False;Property;_RimLight_Color;RimLight_Color;19;0;Create;True;0;0;0;False;0;False;1,0,0,0;1,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PowerNode;155;487.7874,-2764.904;Inherit;False;False;2;0;COLOR;0,0,0,0;False;1;FLOAT;0.09;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;80;658.3538,-2745.094;Inherit;True;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;164;-3633.213,-2024.691;Inherit;False;RimLight;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;21;-1232.013,-1250.182;Inherit;True;Inverse Lerp;-1;;9;09cbe79402f023141a4dc1fddd4c9511;0;3;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;139;-3257.12,-2372.902;Inherit;False;Property;_Invisibility_tint;Invisibility_tint;14;0;Create;True;0;0;0;False;0;False;0,0.3698164,0.972549,1;0.08632845,0.9716981,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RegisterLocalVarNode;82;897.7687,-2688.375;Inherit;False;Emmesive;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;96;362.9641,-1967.713;Inherit;False;70;Specular;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;72;351.0808,-2201.767;Inherit;True;67;DirectLight;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;93;348.5785,-2369.811;Inherit;True;47;Diffuse;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;165;-3156.125,-2452.408;Inherit;False;164;RimLight;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;140;-2869.641,-2482.16;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;190;-3031.983,-2291.209;Inherit;False;82;Emmesive;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;74;574.3848,-2073.302;Inherit;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;94;774.4686,-2247.761;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;121;-826.9968,-1135.38;Inherit;False;Property;_Transicion_Color;Transicion_Color;11;0;Create;True;0;0;0;False;0;False;0,0.3981171,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;75;941.8602,-2051.892;Inherit;True;Visible;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;28;-347.343,-1226.89;Inherit;True;TripleLerpFunction;-1;;11;1f875714d3afa44f6abb1d2e0e07c495;0;5;4;FLOAT;0;False;6;FLOAT;0;False;13;COLOR;0,0,0,0;False;14;COLOR;1,0.4745,0,0;False;15;COLOR;1,1,1,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;191;-23.94312,-1154.135;Inherit;False;Property;_TransEmmisive_Intensity;TransEmmisive_Intensity;13;0;Create;True;0;0;0;False;0;False;1.294118;0;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;-1386.787,-458.6519;Float;False;True;-1;2;ASEMaterialInspector;0;0;CustomLighting;shader;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Off;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0.5;True;True;0;True;Transparent;;Geometry;All;18;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;2;5;False;-1;10;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;0;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=6F86A52C7219303FFEC6F245BD9E6E88A0FD4B51